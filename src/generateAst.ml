...
let generate_operator identifier linenum= OperandName(identifier,linenum,NotDefined)
let generate_integer  literal linenum=  Value(Intliteral(literal,linenum),linenum,NotDefined)
let generate_float  literal linenum=   Value(Floatliteral(literal,linenum),linenum,NotDefined)
...
let generate_defined_type identifier linenum= Definedtype(Identifier(identifier,linenum),NotDefined,linenum)
...
let generate_selector_expr exp identifier linenum= Selectorexpr(exp, identifier,linenum,NotDefined)
let generate_type_casting_expr typename expr linenum= TypeCastExpr(typename, expr,linenum,NotDefined)
let generate_func_expr identifier expressions linenum= FuncCallExpr(identifier, expressions,linenum ,NotDefined)
let generate_index_expr expr1 expr2 linenum= Indexexpr (expr1, expr2,linenum ,NotDefined)
let generate_parathesis_expression exp linenum= OperandParenthesis(exp,linenum ,NotDefined)
let generate_append_expression identifier exp linenum= Appendexpr (identifier, exp,linenum ,NotDefined)
...
let generate_unary_expression op exp linenum= match op with 
									| '-' -> Unaryexpr(UnaryMinus(exp,linenum,NotDefined),linenum,NotDefined)
									| '+' -> Unaryexpr(UnaryPlus(exp,linenum,NotDefined),linenum,NotDefined)
									| '^' -> Unaryexpr(UnaryCaret(exp,linenum,NotDefined),linenum,NotDefined)
									| '!' -> Unaryexpr(UnaryNot(exp,linenum,NotDefined),linenum,NotDefined)
let generate_bin_expression op exp1 exp2 linenum= match op with
									| "&&" -> Binaryexpr(AndAndOp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| "||" -> Binaryexpr(OrOrOp (exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| "==" -> Binaryexpr(EqualEqualCmp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| "!=" -> Binaryexpr(NotEqualCmp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| "<" -> Binaryexpr(LessThanCmp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| ">" -> Binaryexpr(GreaterThanCmp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| "<=" -> Binaryexpr(LessThanCmp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| ">=" -> Binaryexpr(GreaterThanOrEqualCmp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| "+" -> Binaryexpr(AddOp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| "-" ->Binaryexpr(MinusOp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| "|" -> Binaryexpr(OrOp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| "^" -> Binaryexpr(CaretOp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| "*" -> Binaryexpr(MulOp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| "/" -> Binaryexpr(DivOp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| "%" -> Binaryexpr(ModuloOp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| ">>" -> Binaryexpr(SrOp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| "<<" -> Binaryexpr(SlOp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| "&" -> Binaryexpr(AndOp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
									| "&^" ->Binaryexpr(AndCaretOp(exp1,exp2,linenum,NotDefined),linenum,NotDefined)
